...
SET XTASK=Configure Windows Media Player
...
:THEEND
IF EXIST "%windir%\System32\Sysprep\unattend.xml" (DEL /Q "%windir%\System32\Sysprep\unattend.xml" >NUL)
@Echo =============================================================== >>%LOGFILE%
@Echo %DATE% %TIME% >>%LOGFILE%
CLS && @Echo Specialization complete && @Echo System will now reboot && @Echo.
TIMEOUT /T 15