...
SET XTASK=Disable the Network Selection popup
...
SET XTASK=Disable autorun Windows Defender
...
SET XTASK=Disable Malicious Software Removal Tool (MSRT)
REG ADD HKLM\SOFTWARE\Policies\Microsoft\MRT /v DontOfferThroughWUAU /t REG_DWORD /d 1 /f >NUL
@Echo %ERRORLEVEL%    %XTASK% >>%LOGFILE%

SET XTASK=Configure default Consent (Windows Error Reporting)
